...
def filter_words(words, skip_words):
    ...
    for skipped_word in skip_words:
        if skipped_word in words:
            words.remove(skipped_word)
...
def normalise_input(user_input):
    ...
    split_list = no_punct.split()

    important_words = filter_words(split_list, skip_words)
